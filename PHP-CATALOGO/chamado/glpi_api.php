...
function iniciarSessaoGLPI($api_url, $app_token, $user_token, &$error_details)
{
    ...
    if ($http_code < 200 || $http_code >= 300) {
        $error_details = "Erro de HTTP: Status " . $http_code . ". Resposta do servidor: " . ($response ?: 'Nenhuma resposta recebida.');
        return null;
    }
    ...
    if (isset($data['session_token'])) {
        ...
        $error_details = 'Erro da API do GLPI: ' . ($response ?: 'Resposta recebida, mas sem session_token.');
        return null;
    }
}
